...
router.post("/", upload.single("audioFile"), (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!fs.existsSync("public/uploads")) {
            yield mkdirAsync("public/uploads", { recursive: true });
        }
        ...
        yield writeFileAsync(tempWebMFilePath, req.file.buffer);
        yield convertToMp3(tempWebMFilePath, tempMp3FilePath);
        ...
        const output = yield replicate.run("thomasmol/whisper-diarization:7fa6110280767642cf5a357e4273f27ec10ebb60c107be25d6e15f928fd03147", {
            input: {
                file_url: mp3FileUrl,
            },
        });
        ...
        yield unlinkAsync(tempWebMFilePath);
        yield unlinkAsync(tempMp3FilePath);
        res.send({ output });
...
router.post("/listen", (req, res) => __awaiter(this, void 0, void 0, function* () {
