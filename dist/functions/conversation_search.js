 ...
 */
function textSearch(userId, queryString, count = null, start = null) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // );
        console.log(`textSearch: searching for ${queryString} (c=${count}, s=${start}) in ${_messageLogs.length} total messages`);
        // Perform case-insensitive search.
        const matches = _messageLogs.filter((d) => d.content && d.content.toLowerCase().includes(queryString.toLowerCase()));
        console.log(`textSearch - matches:`, start !== null && count !== null
 ...
 */
function conversationSearch(userId, query, page = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [results, total] = yield textSearch(userId, query, count, page * count);
