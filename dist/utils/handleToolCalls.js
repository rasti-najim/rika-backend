...
function handleToolCalls(userId, completion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (completion.choices[0].message.tool_calls[0].function.name ===
            "core_memory_append") {
            const memoryStatus = yield coreMemoryAppend(userId, arguments.name, arguments.content);
            ...
            "core_memory_replace") {
            yield coreMemoryReplace(userId, arguments.name, arguments.old_content, arguments.new_content);
        }
        else if (completion.choices[0].message.tool_calls[0].function.name ===
            "conversation_search") {
            console.log("calling conversation_search", arguments.query);
            const searchResult = yield conversationSearch(userId, arguments.query);
            ...
            yield archivalMemoryInsert(userId, arguments.content);
        }
        else if (completion.choices[0].message.tool_calls[0].function.name ===
            "archival_memory_search") {
            console.log("calling archival_memory_search", arguments.query);
            yield archivalMemorySearch(userId, arguments.query);
        }
        return toolMessage;
        // try {
